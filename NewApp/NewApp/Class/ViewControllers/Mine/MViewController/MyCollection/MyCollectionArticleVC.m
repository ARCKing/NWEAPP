...
@interface MyCollectionArticleVC ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
...
- (void)getdataFromNetIsRefresh:(BOOL)refresh{
    ...
    [net userAllCollectionArticleListWithPage:self.page];
